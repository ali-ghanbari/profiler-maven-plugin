...
public final class PredicateFactory {
    ...
    public static <T extends Serializable> Predicate<T> fromSet(final Set<T> set) {
        return new SerializableSetPredicate<>(set);
    }
